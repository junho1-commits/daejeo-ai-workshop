...
var SLIDES_DATA = [
  ...
  },
  {
    ...
    "badge": "⏱️ 실습 1단계",
    "content": "\n      <div class=\"h-full flex flex-col justify-center w-full max-w-6xl mx-auto px-4\">\n        <div class=\"text-center mb-6\">\n          <span class=\"text-sky-400 font-bold text-base md:text-lg uppercase tracking-wider\">실습 1 : 가장 쉬운 입문 프로젝트</span>\n          <h2 class=\"text-3xl md:text-4xl lg:text-5xl font-extrabold text-white mt-1 break-keep\">\n            \"모둠 활동용 3분 집중 타이머 만들기\"\n          </h2>\n          <p class=\"text-lg md:text-xl text-slate-300 mt-2 font-medium break-keep\">단 하나의 프롬프트로 소리와 애니메이션이 있는 멋진 타이머를 완성합니다</p>\n        </div>\n\n        <div class=\"grid grid-cols-1 md:grid-cols-2 gap-6 items-center\">\n          <div class=\"glass-card p-6 rounded-3xl border border-sky-500/40 space-y-4\">\n            <h4 class=\"font-bold text-sky-300 text-lg flex items-center gap-2\">\n              <i data-lucide=\"terminal\" class=\"w-5 h-5\"></i> 안티그래비티 대화창에 넣을 프롬프트\n            </h4>\n            <div class=\"bg-slate-950 p-4 rounded-2xl border border-slate-800 text-xs md:text-sm font-mono text-slate-200 leading-relaxed break-keep\">\n              \"초등 수업용 3분 타이머 웹앱을 단일 index.html로 만들어줘.<br><br>\n              1. 1분, 3분, 5분 프리셋 버튼과 직접 시간 설정 기능<br>\n              2. 화면 중앙에 시원하게 큰 숫자 카운트다운<br>\n              3. 시작, 일시정지, 리셋 버튼<br>\n              4. 10초 전 주황색 경고 깜빡임과 알림음<br>\n              5. 종료 시 폭죽 애니메이션(Canvas Confetti)과 축하 소리<br>\n              6. 교실 빔프로젝터에 어울리는 다크 모드 글래스 UI\"\n            </div>\n          </div>\n\n          <div class=\"space-y-4\">\n            <div class=\"glass-card p-5 rounded-2xl border border-slate-700\">\n              <span class=\"text-xs font-bold text-sky-400 uppercase tracking-wider\">포인트 1</span>\n              <h5 class=\"text-base md:text-lg font-bold text-white mt-1\">단일 파일(Single HTML)로 요청하기</h5>\n              <p class=\"text-xs md:text-sm text-slate-300 mt-1 break-keep\">HTML 하나에 CSS와 JS를 모두 넣어달라고 하면 파일 관리가 10배 쉬워집니다.</p>\n            </div>\n\n            <div class=\"glass-card p-5 rounded-2xl border border-slate-700\">\n              <span class=\"text-xs font-bold text-purple-400 uppercase tracking-wider\">포인트 2</span>\n              <h5 class=\"text-base md:text-lg font-bold text-white mt-1\">오픈소스 라이브러리 활용 지시</h5>\n              <p class=\"text-xs md:text-sm text-slate-300 mt-1 break-keep\">\"Canvas Confetti(폭죽) CDN 넣어줘\"라고 덧붙이면 화려한 효과가 붙습니다.</p>\n            </div>\n\n            <button onclick=\"window.fireConfetti()\" class=\"w-full py-3.5 rounded-2xl bg-sky-600 hover:bg-sky-500 text-white font-bold text-sm md:text-base transition-all flex items-center justify-center gap-2 shadow-lg shadow-sky-500/30\">\n              <i data-lucide=\"sparkles\" class=\"w-5 h-5\"></i>\n              타이머 완성 축하 폭죽 효과 미리보기\n            </button>\n          </div>\n        </div>\n      </div>\n    ",
    "agentInsights": {
      "pm": "첫 번째 실습으로서 성공 경험을 극대화할 수 있는 타이머를 배치했습니다.",
      "content": "복사해 넣을 수 있는 정밀 프롬프트와 핵심 팁 2가지를 안내합니다.",
      "design": "폭죽 체험 버튼으로 실시간 재미 요소를 더했습니다.",
      "qa": "프롬프트 내용에 군더더기가 없습니다.",
      "consultant": "교실에서 가장 유용하게 매일 쓰이는 도구라 실습 만족도가 매우 높습니다."
    },
    "presenterNote": "\n      🎤 [강사용 추천 멘트]:\n      - \"선생님들, 지금 바로 이 프롬프트를 복사해서 안티그래비티에 넣어보세요. 15초 뒤에 화면 오른쪽에 시계가 째깍째깍 움직이기 시작합니다!\"\n    "
  },
  {
    "id": 14,
...
var TEACHER_NOTES = [
  ...
  },
  {
    "slideId": 13,
    "time": "10분",
    "expectedAnswers": "'진짜 15초 만에 타이머가 만들어지고 소리도 나요!'",
    "confusingPoints": "'소리가 안 나요.' ➔ '브라우저 화면을 한 번 클릭하면 소리가 정상 출력됩니다.'",
    "keyTerms": "실습 1, 3분 집중 타이머, 단일 파일(index.html), Confetti 폭죽"
  },
  {
    "slideId": 14,
    "time": "10분",
